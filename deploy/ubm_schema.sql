...
--
-- Name: report_unmapped_recs(text); Type: FUNCTION; Schema: tps; Owner: -
--

CREATE FUNCTION tps.report_unmapped_recs(_srce text) RETURNS TABLE(source text, map text, ret_val jsonb, count bigint, recs jsonb)
    LANGUAGE plpgsql
    AS $$ 
BEGIN
